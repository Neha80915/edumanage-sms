...
import { GraduationCap, Mail, Lock, AlertCircle, UserCog, Users, User } from 'lucide-react';
...
export function Login() {
  ...
  const quickAccounts = [
    { role: 'Admin', email: 'admin@school.com', icon: UserCog, color: 'from-violet-500 to-purple-600', bg: 'bg-violet-50', border: 'border-violet-200', text: 'text-violet-700' },
    { role: 'Teacher', email: 'sunita.mehta@school.com', icon: Users, color: 'from-blue-500 to-cyan-500', bg: 'bg-blue-50', border: 'border-blue-200', text: 'text-blue-700' },
    { role: 'Student', email: 'ananya.sharma@school.com', icon: User, color: 'from-emerald-500 to-teal-500', bg: 'bg-emerald-50', border: 'border-emerald-200', text: 'text-emerald-700' },
  ];
    ...
    <div className="min-h-screen flex" style={{ background: 'linear-gradient(135deg, #0f172a 0%, #1e1b4b 50%, #0f172a 100%)' }}>
      ...
      <div className="hidden lg:flex flex-col justify-center items-center w-1/2 p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          <h1 className="text-4xl font-bold text-white mb-4 leading-tight">EduManage</h1>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-400 truncate" style={{ maxWidth: '80px' }}>{acc.email.split('@')[0]}</p>
                      </div>
                    </button>
                  );
                })}
